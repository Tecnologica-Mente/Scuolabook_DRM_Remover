...
::===========================================================================================================
::
::   This script is a DRM Protection Removal and Downloader for Scuolabook Platform.
::   (It can be used to download books in PDF format from Scuolabook web reader)
::
...
::   ********************************************************************************************************
::
::   Born from an idea of ​​Edoardo. Thanks to Antonio for providing me the access credentials to Scuolabook
::
::===========================================================================================================
...
cls
color 07
title  Scuolabook DRM Remover AIO v1.0.0
mode 100, 30
set "sdrmrtemp=%SystemRoot%\Temp\__SDRMR"
if exist "%sdrmrtemp%\.*" rmdir /s /q "%sdrmrtemp%\" %nul%

echo:
echo:
echo:             Welcome to Scuolabook DRM Remover AIO v1.0.0
echo:
...
echo:             [2] To remove the DRM protection and download your Scuolabook PDF eBooks
...
if %_erl%==4 exit /b
if %_erl%==3 start https://github.com/Tecnologica-Mente/Scuolabook_DRM_Remover 	& goto :MainMenu
